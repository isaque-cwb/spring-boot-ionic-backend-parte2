...
import com.isaquelourenco.cursomc.domain.Categoria;
...
import com.isaquelourenco.cursomc.domain.PagamentoComCartao;
import com.isaquelourenco.cursomc.domain.Pedido;
import com.isaquelourenco.cursomc.domain.Produto;
...
import com.isaquelourenco.cursomc.repositories.CategoriaRepository;
import com.isaquelourenco.cursomc.repositories.CidadeRepository;
...
import com.isaquelourenco.cursomc.repositories.EstadoRepository;
...
import com.isaquelourenco.cursomc.repositories.ProdutoRepository;
...
public class DBService {
	...
	public void InstatiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "isaque.modern@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("273363323", "41 99565-5887"));
		
		Cliente cli2 = new Cliente(null, "Ana Costa", "isaque.lourenco2@gmail.com", "14884177096", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli2.addPerfil(Perfil.ADMIN);
		cli2.getTelefones().addAll(Arrays.asList("3359-5632", "41 99565-5887"));

		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "apto 303", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "sala 800", "Centro", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Avenida Floriano", "2106", null, "Centro", "82.820-090", cli2, c2);
